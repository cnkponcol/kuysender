                        ...
                        <div class="bs-stepper-content">
                            <form id="form-campaign-store" method="POST" onSubmit="return false">
                                ...
                                <div id="step3" class="content">
                                    <div class="alert alert-info">Only contacts with explicit opt-in are queued. Contacts marked unknown or opted-out are automatically skipped.</div>
                                    <div class="row g-3">
                                        <div class="col-12 col-md-3"><label class="form-label">Minimum delay (seconds)</label><input type="number" name="delay" class="form-control" required min="5" max="3600" value="15"></div>
                                        <div class="col-12 col-md-3"><label class="form-label">Maximum delay</label><input type="number" name="delay_max" class="form-control" required min="5" max="3600" value="45"></div>
                                        <div class="col-12 col-md-3"><label class="form-label">Maximum recipients</label><input type="number" name="max_recipients" class="form-control" min="1" max="10000" placeholder="All opted-in"></div>
                                        <div class="col-12 col-md-3"><label class="form-label">Auto pause error rate %</label><input type="number" name="stop_error_rate" class="form-control" min="5" max="100" value="35"></div>
                                        <div class="col-12 col-md-4"><label class="form-label">Scheduled at</label><input type="datetime-local" name="scheduled_at" class="form-control" value="{{ now()->format('Y-m-d\TH:i') }}"></div>
                                        <div class="col-6 col-md-4"><label class="form-label">Send from</label><input type="time" name="send_window_start" class="form-control" value="09:00"></div>
                                        <div class="col-6 col-md-4"><label class="form-label">Send until</label><input type="time" name="send_window_end" class="form-control" value="20:00"></div>
                                        <div class="col-12 d-flex justify-content-between"><button class="btn btn-label-secondary btn-prev" disabled type="button"><i class="ti ti-arrow-left me-sm-1 me-0"></i><span class="align-middle d-sm-inline-block d-none">Previous</span></button><button type="submit" class="btn btn-primary btn-next is-campaign-store" data-id="step2"><span class="align-middle">Create Campaign</span></button></div>
                                    </div>
                                </div>
                            </form>
                        </div>
