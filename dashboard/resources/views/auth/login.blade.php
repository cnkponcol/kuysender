...
<head>
    ...
    <title>LOGIN - KUY SENDER</title>

    <meta name="description" content="KUY SENDER" />
            ...
            <div class="authentication-inner py-4">
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <!-- /Logo -->
                        <h4 class="mb-1 pt-2">Welcome KUY SENDER 👋</h4>
                        <p class="mb-4">Please sign-in to your account!<br><br>Demo Account<br>username : demo<br>password : demo12345678</p>
