                        ...
                        <div class="col-12 col-xl-6 col-lg-6">
                            <div class="mb-3"><label class="form-label">Media</label>
                                <div class="input-group">
                                    <input type="text" class="form-control" value="{{ $data->url ?? (isset($data->storage_path) ? route('storage', ['url' => $data->storage_path]) : '') }}" name="media">
                                    <input type="hidden" name="media_storage_path" value="{{ $data->storage_path ?? '' }}">
                                    <button class="btn btn-primary waves-effect filemanagerilsya" type="button">Pilih File</button>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-xl-6 col-lg-6">
                            <div class="mb-3">
                                <label class="form-label">Media Mime</label><select name="media_type" required class="form-select">
                                    ...
                                    <option {{ $data->media_type == 'document' ? 'selected' : '' }} value="document">Document</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-12">
    ...
    <script>
        (function() {
            ...
            $(document).on('click', '.getfiles-ilsya', function() {
                ...
                $("input[name='media']").val($(this).data('url'))
                $("input[name='media_storage_path']").val(path)
                const selectedMime = String($(this).data('mime') || '');
                $("select[name='media_type']").val(selectedMime === 'image' ? 'image' : 'document')
                $("#modal-files").modal('hide')
            })

            $(document).on('input', "input[name='media']", function() { $("input[name='media_storage_path']").val(''); });
        })()
    </script>
@endpush
