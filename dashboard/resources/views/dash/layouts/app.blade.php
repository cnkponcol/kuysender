...
<head>
    ...
    <title>KUY SENDER - {{ \Str::ucfirst(\Str::lower($__env->yieldContent('title'))) }}</title>
    ...
    <link rel="stylesheet" href="{!! asset('assets') !!}/css/kuysender-mobile.css?v=1" />
...
<body>
    ...
    <div class="layout-wrapper layout-content-navbar">
        ...
        @include('dash.layouts.mobile_nav')
    ...
    @if (session('success'))
        <script>Swal.fire({text: @json(session('success')), icon: 'success', customClass:{confirmButton:'btn btn-primary'}, buttonsStyling:false});</script>
    @endif
