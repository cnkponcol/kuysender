...
const config = Object.freeze({
  ...
  reconnectMinMs: Math.max(5000, int('WA_RECONNECT_MIN_MS', 15000)),
  reconnectMaxMs: Math.max(30000, int('WA_RECONNECT_MAX_MS', 120000)),
  reconnectMaxAttempts: Math.max(1, int('WA_RECONNECT_MAX_ATTEMPTS', 5)),
  reconnectCooldownMs: Math.max(60000, int('WA_RECONNECT_COOLDOWN_MS', 900000)),
